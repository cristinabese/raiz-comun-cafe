...
const products = [
  { name: "New York", category: "Brunch", description: "Pan integral, huevo, aguacate, salmón y salsa de yogur.", price: 8.4, image: "https://images.unsplash.com/photo-1525351484163-7529414344d8?auto=format&fit=crop&w=900&q=82" },
  { name: "Higo Chungo", category: "Brunch", description: "Pan brioche, yogur, higos, frutos rojos y miel.", price: 11.9, image: "https://images.unsplash.com/photo-1490474418585-ba9bad8fd0ea?auto=format&fit=crop&w=900&q=82" },
  { name: "Pikito", category: "Brunch", description: "Huevos, champiñones, queso parmesano y pan de masa madre.", price: 12.9, image: "https://images.unsplash.com/photo-1533089860892-a7c6f0a88666?auto=format&fit=crop&w=900&q=82" },
  { name: "Aguacatado", category: "Entrantes", description: "Aguacate, huevo, queso cottage, tomate y AOVE.", price: 9.9, image: "https://images.unsplash.com/photo-1603046891744-76e6300f82ef?auto=format&fit=crop&w=900&q=82" },
  { name: "Tostada de aguacate", category: "Entrantes", description: "Pan artesano, aguacate, semillas y aceite de oliva.", price: 6.5, image: "https://images.unsplash.com/photo-1541519227354-08fa5d50c44d?auto=format&fit=crop&w=900&q=82" },
  { name: "Porridge de frutos rojos", category: "Bowls", description: "Avena cremosa, fruta fresca, granola y miel.", price: 5.5, image: "https://images.unsplash.com/photo-1517093728432-a0440f8d45af?auto=format&fit=crop&w=900&q=82" },
